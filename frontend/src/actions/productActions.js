...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/products`, {}, config);
...
export const createProductReview =
  (productId, review) => async (dispatch, getState) => {
    try {
      ...
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/products/${productId}/reviews`, review, config);
